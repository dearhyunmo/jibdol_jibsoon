            ...
            <div class="flex_cell_inner">
              ...
              >
                <div class="avia_textblock" itemprop="text">
                  <p class="sub-title en-txt03"><span class="txt-ani">My info</span><br /></p>
                </div>
              </section>
            </div>
          </div>
                ...
                <div class="avia-image-container-inner" style="width: 90%">
                  <div class="type03">
                    <form action="" method="">
                        ...
                        <table>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td colspan="3">${mem.userid}</td>
                            </tr>
                            <tr>
                              <th scope="row"><label for="wr-tit">Name</label></th>
                              <td colspan="3">${mem.name}</td>
                            </tr>
                            <tr>
                              <th scope="row"><label for="wr-tit">email</label></th>
                              <td colspan="3">${mem.email}</td>
                            </tr>
                            <tr>
                              <th scope="row">주소</th>
                              <td colspan="3">
                            ...
                            <tr>
                              ...
                              <td colspan="3">
                                <div class="b-tel-box">
                                  <label for="wr-tel-st">전화번호</label>${mem.phone}
                                </div>
                              </td>
                            </tr>
                          </tbody>
                      ...
                      <c:if test="${(user eq 'admin') }"></c:if>
                      <c:if test="${user ne 'admin' }"><button type="button"  onclick="location.href='signupdate?userid=${user}'" style="width: 120px; height: 40px">회원 정보 수정</button></c:if>
                        <c:if test="${mem.userid eq 'admin' }"></c:if>
                        <c:if test="${mem.userid ne 'admin' }"><button type="button"  onclick="location.href='deleteuser?userid=${user}'" style="width: 100px; height: 40px">회원 탈퇴</button></c:if>
                        <button type="button" style="width: 120px; height: 40px">메인 페이지로</button>
                      </div>
                    </form>
                  </div>
                </div>
