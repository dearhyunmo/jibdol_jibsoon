  ...
  >
	...
	<div id="main" class="all_colors" data-scroll-offset="0">
          ...
          >
            <div class="flex_cell_inner searchresult">
              ...
              >
                ...
                <div
                  class="avia-image-container-inner"
                ...
                <ul id="category" class="login">
			        ...
			        <li id="PS3" data-order="2"> 
			            <span class="category_bg ps3"></span>
			            어린이집, 유치원
			        </li>  
			        <li id="SC4" data-order="3"> 
			            <span class="category_bg sc4"></span>
			            학교
			        </li>  
              ...
              <script
                ...
                src="//dapi.kakao.com/v2/maps/sdk.js?appkey=53a87b945854a8503a27ecf8ff801da0&libraries=services"
              ></script>
              <script>
			      ...
			      var options = { //지도를 생성할 때 필요한 기본 옵션
			         center : new kakao.maps.LatLng(parseFloat(json.lat),
			               parseFloat(json.lng)), //지도의 중심좌표.
			         level : 3
			      //지도의 레벨(확대, 축소 정도)
			      };
			      var map = new kakao.maps.Map(container, options); //지도 생성 및 객체 리턴
			
			         var markerPosition = new kakao.maps.LatLng(parseFloat(json.lat),
			               parseFloat(json.lng));
            ...
            <div class="flex_cell_inner searchresult">
              ...
              >
                ...
                <c:if test="${!empty houselist }">
                			<div class="search_txt detailtitle">
		                      <span>${houselist.aptName }</span>
                			</div>
		                    <div class="search_txt detailview" >
		                      <span>주소 : ${houselist.city} ${houselist.gugun} ${houselist.dong} ${houselist.jibun}번지</span><br /><br />
		                      <span>금액 : ${houselist.dealAmount } 만원</span><br /><br />
		                      <span>건축년도 : ${houselist.buildYear } 년</span><br /><br />
		                      <span>면적 : ${houselist.area} m<sup>2</sup></span><br /><br />
		                      <span>층 수 : ${houselist.floor} 층</span><br /><br />
		                      </div>
                </c:if>
        ...
        <div
            ...
            style="vertical-align: top; padding: 0"
          >
            <div class="flex_cell_inner croadview">
            <div class="no-login" style="height:500px;background-image:url(resources/img/roadview.jpg); padding:30px; background-size:contain">
            	<ul class="no-login" style="background-color: rgba( 255, 255, 255, 0.7 ); width:85%; height:60%; text-align:center; padding:30px; margin:auto;">
                	<li>
                		로그인 하시면 이용 가능합니다!
                	</li>
                	<li>
              ...
              <div id="roadview"  class="login" style="height:500px">
                </div>
                <script>
                	var json = JSON.parse('${Marker}');
	                ...
	                var position = new kakao.maps.LatLng(parseFloat(json.lat),
				               parseFloat(json.lng));
